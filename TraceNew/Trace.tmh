// 8d881e8b9c0755be9ab5898277fcd088 Generated file. Do not edit.
...
# define WPP_ANNOTATE_Trace_h1884_FINAL(P, File, Name, ...) __annotation( \
    L ## P, \
    L"c6ae3f6e-f898-3027-6ef3-6662ac0d4748 Trace // SRC=" _WPPW(File) \
    L" MJ= MN=", \
    L"#typev " _WPPW(Name) \
    L" 10 \"%0--> %10!s!\" //   TRACELEVEL=TRACE_LEVEL_VERBOSE" \
    WPP_FUNC_NAME, \
...
#define WPP_LOCAL_TraceGuids WPP_c6ae3f6ef89830276ef36662ac0d4748_Traceguids
extern const __declspec(selectany) GUID WPP_LOCAL_TraceGuids[] = { {0xc6ae3f6e,0xf898,0x3027,{0x6e,0xf3,0x66,0x62,0xac,0x0d,0x47,0x48}}, };
