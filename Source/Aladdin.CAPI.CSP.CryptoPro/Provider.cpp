...
Aladdin::CAPI::CSP::CryptoPro::Provider::CreateGOST28147(String^ paramOID)
{$
...
Aladdin::CAPI::CSP::CryptoPro::Provider::EnumerateAllObjects(Scope scope)
{$
...
Aladdin::CAPI::CSP::CryptoPro::Provider::GetSecretKeyType(
...
String^ Aladdin::CAPI::CSP::CryptoPro::Provider::ConvertKeyOID(ALG_ID keyOID) 
{$
...
ALG_ID Aladdin::CAPI::CSP::CryptoPro::Provider::ConvertKeyOID(String^ keyOID, DWORD keyType)
{$
...
String^ Aladdin::CAPI::CSP::CryptoPro::Provider::GetExportKeyOID(String^ keyOID, DWORD keyType)
{
    if (keyOID == ASN1::GOST::OID::gostR3410_2001)
    {
...
Aladdin::CAPI::CSP::CryptoPro::Provider::CreateExportKeyWrap(
...
Aladdin::CAPI::CSP::CryptoPro::Provider::ImportKeyPair(
...
{$
	...
	CAPI::CSP::SecretKey KEK(this, GOST::Keys::GOST::Instance, hKEK.Get()); 
	...
	// создать алгоритм шифрования ключа
	Using<CAPI::KeyWrap^> keyWrap(CreateExportKeyWrap(
	...
	SecretKeyFactory^ typeCEK = (valueCEK->Length == 32) ? 
		GOST::Keys::GOST::Instance : SecretKeyFactory::Generic; 
	...
	Using<CAPI::KeyDerive^> keyDerive(((Wrap::RFC4357^)keyWrap.Get())->GetKDFAlgorithm(Handle)); 
...
Aladdin::CAPI::CSP::KeyHandle^ Aladdin::CAPI::CSP::CryptoPro::Provider::ImportPublicKey(
...
Aladdin::CAPI::CSP::CryptoPro::Provider::ExportPublicKey(
...
Aladdin::CAPI::CSP::CryptoPro::Provider::GetPrivateKey(
...
Aladdin::CAPI::CSP::CryptoPro::Provider::CreateAlgorithm(
...
{$
	for (int i = 0; i < 1; i++)
	{
		...
		else if (type == CAPI::KeyDerive::typeid)
		{
		...
		else if (type == CAPI::KeyWrap::typeid)
		{
		...
		else if (type == CAPI::SignHash::typeid)
		{
		...
		// для алгоритмов подписи данных
		else if (type == CAPI::VerifyData::typeid)
		{
			if (oid == ASN1::GOST::OID::gostR3411_94_R3410_2001) 
			{
				// создать алгоритм подписи хэш-значения
		...
		else if (type == CAPI::IKeyAgreement::typeid)
		{
			if (oid == ASN1::GOST::OID::gostR3410_2001)
			{
