...
///////////////////////////////////////////////////////////////////////
void Aladdin::CAPI::CSP::CryptoPro::GOSTR3410::PrivateKey::GetPrivateValue()
{$
	...
	Using<CAPI::KeyWrap^> keyWrap(provider->CreateExportKeyWrap(hContext, exportID, sboxOID, ukm)); 

	// создать объект ключа
	CAPI::CSP::SecretKey KEK(provider, GOST::Keys::GOST::Instance, hKEK.Get()); 
