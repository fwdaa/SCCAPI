...
namespace Aladdin.ASN1.ISO.PKIX
{
	...
	public class ObjectDigestInfo : Sequence
	{
		...
		private static readonly ObjectInfo[] info = new ObjectInfo[] { 
			...
			new ObjectInfo(new ObjectCreator<Enumerated<DigestedObjectType>>().Factory(), Cast.N), 
		...
		public ObjectDigestInfo(Enumerated<DigestedObjectType> digestedObjectType, 
		...
		public Enumerated<DigestedObjectType>	DigestedObjectType	{ get { return (Enumerated<DigestedObjectType>	)this[0]; }} 
