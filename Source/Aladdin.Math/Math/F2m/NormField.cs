...
namespace Aladdin.Math.F2m
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    [Serializable]
    public class NormField : Field, IEquatable<NormField>
    {
        ///////////////////////////////////////////////////////////////////////
        // Типы нормальных базисов
        ///////////////////////////////////////////////////////////////////////
        private static readonly int[] DefaultT = new int[] {
            0,  0,  2,  2,  1,  2,  2,  4,						/*    0 -    7 */
        ...
        // Образующие элементы
        ///////////////////////////////////////////////////////////////////////
        private static readonly int[] DefaultU = new int[] {
        ...
        private static int GenerateOrder(int T, int p) 
        {
            ...
            if (((p - 1) % T) != 0) throw new ArgumentException(); 
        ...
        ///////////////////////////////////////////////////////////////////////
        private static void CalculateNB(int[] defaultT, int[] defaultU) 
        {
            ...
            for (int m = 0; m < defaultT.Length; m++)
            {
                ...
                if ((m % 8) == 0) Console.Out.WriteLine();
            
                // вывести значение образующего элемента
                Console.Out.Write(String.Format("{0,5}, ", defaultU[m]));
            }
        }
        ///////////////////////////////////////////////////////////////////////
        // матрица коэффициентов, тип нормального базиса и единичный элемент
        private Matrix matrix; private int T; private Vector one;  

        // конструктор
        public NormField(int m) : this(m, DefaultT[m], DefaultU[m]) {}
        // конструктор
        public NormField(int m, int T, int u) : base(m)
        {
            // создать список индексов
            this.T = T; int p = T * m + 1; int[] F = new int[p - 1];  
        ...
        public int Type { get { return T; }}

        // сравнение полей
        public virtual bool Equals(NormField other)
        {
            // сравнение полей
        ...
        public override bool Equals(Object other)
        {
		    ...
		    if (!(other is NormField)) return false;

		    // сравнить значения элементов
		    return Equals((NormField)other);
        }
        // получить хэш-код объекта
        public override int GetHashCode() { return M ^ T; }
        ...
        public override Vector Invert(Vector a)
        {
            ...
            Vector b = a; int m1 = M - 1; uint mask = 1u << 31; 
        ...
        public override Vector Product(Vector a, Vector b)
        {
            ...
            for (int i = 0; i < matrix.Rows; i++)
            {
                ...
                builder[i] = shiftA.Product(matrix).Product(shiftB);
        ...
        public override Vector Sqr(Vector a) { return a.Rcr(1); } 

        // вычисление квадратного корня
        public override Vector Sqrt(Vector a) { return a.Rcl(1); } 

        //////////////////////////////////////////////////////////////////////
        // Специальные функции
        ///////////////////////////////////////////////////////////////////////
        public override int Trace(Vector a) { return a.Product(one); }

        // корень z квадратного уравнения z^2 + z = beta
        public override Vector QuadraticRoot(Vector beta)
        {
            // создать буфер для вектора
            VectorBuilder builder = new VectorBuilder(M); builder[0] = 0;
        
            // для всех битов
            for (int i = 1, bit = 0; i < M; i++)
            {
                // вычислить значение бита
                bit = bit ^ beta[i]; builder[i] = bit; 
            }
            // создать вектор
