...
Aladdin::CAPI::ANSI::CNG::Microsoft::RegistryStore::GetCertificateChain(Certificate^ certificate) 
{$
	// указать месторасположение хранилища в реестре
	DWORD location = (Scope == CAPI::Scope::System) ? 
		CERT_SYSTEM_STORE_LOCAL_MACHINE : CERT_SYSTEM_STORE_CURRENT_USER; 
...
void Aladdin::CAPI::ANSI::CNG::Microsoft::RegistryStore::SetCertificateChain(
