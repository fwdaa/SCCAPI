...
// Шаблон FCI (0x6F)
///////////////////////////////////////////////////////////////////////////////
public class FileControlInformation extends DataObjectTemplate
{
    // раскодировать описание файла
    public static FileControlInformation decode(DataCoding dataCoding, byte[] content) throws IOException
    {
        ...
        if (content.length == 0 || content[0] != 0x6F) 
        {
            ...
            IEncodable encodable = Encodable.decode(content); 
    ...
    public FileControlInformation(DataObject... objects)
    {    
        // сохранить переданные параметры
        super(Authority.ISO7816, Tag.FILE_CONTROL_INFORMATION, objects); 
    }
    // конструктор раскодирования
    public FileControlInformation(TagScheme tagScheme, byte[] content) throws IOException
    {    
        // сохранить переданные параметры
        super(Authority.ISO7816, Tag.FILE_CONTROL_INFORMATION, tagScheme, content); 
    } 
    // объединить объекты описания
    public final FileControlInformation сombine(DataObjectTemplate objects)
    {
        ...
        // вернуть новый набор
        return new FileControlInformation(objs.toArray(new DataObject[objs.size()])); 
    }
