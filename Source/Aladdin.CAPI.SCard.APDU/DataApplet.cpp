...
#include "DataApplet.tmh"
#endif 

///////////////////////////////////////////////////////////////////////////
// Апплет DataStore
///////////////////////////////////////////////////////////////////////////
array<BYTE>^ Aladdin::CAPI::SCard::APDU::DataStore::Applet::GetSerial()
{$
	try { 
		// выбрать управляющий апплет на смарт-карте
		JCFamily::Instance->SelectApplet(Session, Card->ATR, "JavaManager"); 

		// передать команду GET DATA (Pre-issuing data) смарт-карте
		ISO7816::Response^ response = Session->SendCommand(
			0x00, 0xCA, 0x00, 0x46, gcnew array<BYTE>(0), 0
		);
