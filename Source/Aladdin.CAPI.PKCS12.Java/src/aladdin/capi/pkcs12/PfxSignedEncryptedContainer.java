...
///////////////////////////////////////////////////////////////////////////
public class PfxSignedEncryptedContainer 
    extends PfxEncryptedContainer implements IPfxSignedContainer
{
    // личный ключ и сертификат
	private IPrivateKey privateKey; private Certificate certificate;
 
	// конструктор
	public PfxSignedEncryptedContainer(PFX content, Factory factory, IRand rand) throws IOException
    {
		// сохранить переданные параметры
		super(content, factory, rand); privateKey = null; certificate = null; 
    } 
