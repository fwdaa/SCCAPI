...
///////////////////////////////////////////////////////////////////////////
public class PfxAuthenticatedContainer extends PfxContainer implements IPfxAuthenticatedContainer
{
    // фабрика алгоритмов и пароль проверки целостности
    private final Factory factory; private String password;
    
	// конструктор
	public PfxAuthenticatedContainer(PFX content, Factory factory, IRand rand) throws IOException
    { 
