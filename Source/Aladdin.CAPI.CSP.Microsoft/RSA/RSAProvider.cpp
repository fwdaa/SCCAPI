...
Aladdin::CAPI::CSP::Microsoft::RSA::Provider::GetSecretKeyType(
	SecretKeyFactory^ keyFactory, DWORD keySize)
{$
	// в зависимости от типа алгоритма
	if (dynamic_cast<ANSI::Keys::DES^>(keyFactory) != nullptr) 
	{
		// указать идентификатор алгоритма
		return gcnew SecretKeyType(CALG_DES); 
	}
	// в зависимости от типа алгоритма
	if (dynamic_cast<ANSI::Keys::RC4^>(keyFactory) != nullptr) 
	{
		// указать идентификатор алгоритма
		return gcnew SecretKeyType(CALG_RC4);
	}
	// в зависимости от типа алгоритма
	if (dynamic_cast<ANSI::Keys::RC2^>(keyFactory) != nullptr) 
	{
		// указать идентификатор алгоритма
...
Aladdin::CAPI::CSP::Microsoft::RSA::Provider::ImportKeyPair(
...
Aladdin::CAPI::CSP::KeyHandle^ Aladdin::CAPI::CSP::Microsoft::RSA::Provider::ImportPublicKey(
...
Aladdin::CAPI::CSP::Microsoft::RSA::Provider::ExportPublicKey(
...
Aladdin::CAPI::CSP::Microsoft::RSA::Provider::GetPrivateKey(
...
Aladdin::CAPI::CSP::Microsoft::RSA::Provider::CreateGenerator(
