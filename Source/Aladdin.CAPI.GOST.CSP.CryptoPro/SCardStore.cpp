...
///////////////////////////////////////////////////////////////////////////
Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::SCardStore(SecurityStore^ store, String^ name) 

	// сохранить переданные параметры
	: ProviderStore(store, name, SCardContainer::typeid, 0), applet(nullptr)
{$
...
Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::~SCardStore() 
{$
...
array<Type^>^ Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::GetAuthenticationTypes(String^ user)
{$
...
Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::GetAuthenticationService(
...
array<Aladdin::CAPI::Credentials^>^ Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::Authenticate()
{$ 
	// вызвать базовую функцию
...
String^ Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::GetUniqueID()
{$
...
array<String^>^ Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::EnumerateObjects()
{$
...
Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::CreateObject(
...
void Aladdin::CAPI::GOST::CSP::CryptoPro::SCardStore::DeleteObject(
