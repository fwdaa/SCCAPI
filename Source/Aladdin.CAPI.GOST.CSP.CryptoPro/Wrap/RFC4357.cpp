...
///////////////////////////////////////////////////////////////////////////
array<BYTE>^ Aladdin::CAPI::GOST::CSP::CryptoPro::Wrap::RFC4357::Wrap(
...
{$
	...
	{ 
        ...
        Using<KeyDerive^> keyDerive(GetKDFAlgorithm(Context)); 
...
Aladdin::CAPI::ISecretKey^ Aladdin::CAPI::GOST::CSP::CryptoPro::Wrap::RFC4357::Unwrap(
...
// Шифрование ключа
///////////////////////////////////////////////////////////////////////////////
array<BYTE>^ Aladdin::CAPI::GOST::CSP::CryptoPro::Wrap::RFC4357::WrapKey(ALG_ID algID, 
...
Aladdin::CAPI::GOST::CSP::CryptoPro::Wrap::RFC4357::UnwrapKey(
