...
namespace Aladdin.CAPI.GOST.GUI
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public partial class KeyControl2001S : CAPI.GUI.ParametersControl
    {
        // конструктор
        public KeyControl2001S() { InitializeComponent(); }
        ...
        public override IParameters GetParameters()
        {
            ...
            if (radioECC.Checked) paramsOID = ASN1.GOST.OID.ecc_signs_C; 
