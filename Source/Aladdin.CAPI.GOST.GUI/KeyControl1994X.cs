...
namespace Aladdin.CAPI.GOST.GUI
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public partial class KeyControl1994X : CAPI.GUI.ParametersControl
    {
        // конструктор
        public KeyControl1994X() { InitializeComponent(); }
        ...
        public override IParameters GetParameters()
        {
            ...
            if (radioECA.Checked) paramsOID = ASN1.GOST.OID.exchanges_A; else
            if (radioECB.Checked) paramsOID = ASN1.GOST.OID.exchanges_B; else
            if (radioECC.Checked) paramsOID = ASN1.GOST.OID.exchanges_C; 
