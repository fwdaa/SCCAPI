...
namespace Aladdin.CAPI.GOST.GUI
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public partial class KeyControl2012_256S : CAPI.GUI.ParametersControl
    {
        // конструктор
        public KeyControl2012_256S() { InitializeComponent(); }
        ...
        public override IParameters GetParameters()
        {
            ...
            if (radioECA    .Checked) paramsOID = ASN1.GOST.OID.ecc_signs_A; else
            if (radioECB    .Checked) paramsOID = ASN1.GOST.OID.ecc_signs_B; else
            if (radioECC    .Checked) paramsOID = ASN1.GOST.OID.ecc_signs_C; else 
