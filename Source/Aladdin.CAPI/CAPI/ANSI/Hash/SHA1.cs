...
namespace Aladdin.CAPI.ANSI.Hash
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class SHA1 : CAPI.BlockHash
    {
        ...
        private long byteCount; private uint H1, H2, H3, H4, H5;
	    ...
	    protected override void Update(byte[] data, int dataOff)  
        {
            ...
            uint[] X = new uint[80]; byteCount += BlockSize;
            ...
            //
            uint A = H1; uint B = H2; uint C = H3; uint D = H4; uint E = H5;
            //
            // round 1
            //
            int idx = 0;
            ...
            byte[] data, int dataOff, int dataLen, byte[] buf, int bufOff)
        {
            ...
            Math.Convert.FromUInt32(H5, Endian, buf, bufOff + 16); 
        }
        ////////////////////////////////////////////////////////////////////////////
        ...
        // HMAC-PBKDF2
        ////////////////////////////////////////////////////////////////////////////
        public static void TestHMAC_PBKDF2(Factory factory, SecurityStore scope)
        {
            PBE.PBKDF2.Test(factory, scope, null, "password", new byte[] { 
            ...
            PBE.PBKDF2.Test(factory, scope, null, 
            ...
            PBE.PBKDF2.Test(factory, scope, null, "password", 
    ...
    */      PBE.PBKDF2.Test(factory, scope, null, "passwordPASSWORDpassword", 
            ...
            PBE.PBKDF2.Test(factory, scope, null, "pass\0word", 
