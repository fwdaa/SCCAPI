...
{
    ////////////////////////////////////////////////////////////////////////////
    // Режим зашифрования 1-битного CFB
    ////////////////////////////////////////////////////////////////////////////
    public class CFB1_ENC : Transform
    {
        ...
        // конструктор
        public CFB1_ENC(Cipher engine, ISecretKey key, byte[] iv)
        {
        ...
        public override int Update(byte[] data, int dataOff, int dataLen, byte[] buf, int bufOff) 
        {
            ...
            for (int i = 0; i < dataLen; i++) for (int j = 0; j < 8; j++)
            {
                ...
                currentIV[currentIV.Length - 1] |= (byte)((buf[bufOff + i] >> (7 - j)) & 1); 
            }
            return dataLen; 
        }
