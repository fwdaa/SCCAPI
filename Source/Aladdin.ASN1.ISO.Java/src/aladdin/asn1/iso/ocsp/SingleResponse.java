...
public class SingleResponse extends Sequence<IEncodable>
{
	...
	private static final ObjectInfo[] info = new ObjectInfo[] { 
		...
		new ObjectInfo(new SequenceCreator(GeneralizedTime.class).factory(), Cast.N                 ), 
		new ObjectInfo(new SequenceCreator(GeneralizedTime.class).factory(), Cast.EO, Tag.context(0)), 
	...
	public final IEncodable         certStatus      () { return (IEncodable     )get(1); }
