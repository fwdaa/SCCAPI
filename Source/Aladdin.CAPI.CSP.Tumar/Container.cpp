...
///////////////////////////////////////////////////////////////////////////
Aladdin::CAPI::CSP::Tumar::Container::SetActivePrivateKey::SetActivePrivateKey(
...
///////////////////////////////////////////////////////////////////////////
String^ Aladdin::CAPI::CSP::Tumar::Container::GetUniqueID()
{$
...
///////////////////////////////////////////////////////////////////////////
bool Aladdin::CAPI::CSP::Tumar::Container::IsAuthenticationRequired(Exception^ e)
{$
...
void Aladdin::CAPI::CSP::Tumar::Container::SetPassword(String^ password) 
{$
	// получить описатель ключа
...
// Управление ключами
///////////////////////////////////////////////////////////////////////////
DWORD Aladdin::CAPI::CSP::Tumar::Container::GetKeyType(String^ keyOID, KeyUsage keyUsage)
{$
...
array<array<BYTE>^>^ Aladdin::CAPI::CSP::Tumar::Container::GetKeyIDs()
{$
...
Aladdin::CAPI::CSP::Tumar::Container::GetUserKey(array<BYTE>^ keyID, DWORD% keyType)
{$
	// указать начальные условия
	DWORD maxSize = 0; DWORD flags = CRYPT_FIRST; 
...
void Aladdin::CAPI::CSP::Tumar::Container::DeleteKeyPair(array<BYTE>^ keyID) 
{$
	// удалить пару ключей
	Handle->SetParam(PP_CNT_DEL_SN, keyID, 0); 
}

void Aladdin::CAPI::CSP::Tumar::Container::DeleteKeys()
{$
/*
