...
Aladdin::CAPI::CSP::Tumar::Provider::GetSecretKeyType(
...
{$
	...
	return Microsoft::RSA::AESEnhancedProvider::GetSecretKeyType(keyFactory, keySize); 
}

String^ Aladdin::CAPI::CSP::Tumar::Provider::ConvertKeyOID(ALG_ID keyID)
{$
...
ALG_ID Aladdin::CAPI::CSP::Tumar::Provider::ConvertKeyOID(String^ keyID, DWORD keyType)
{$
...
Aladdin::CAPI::CSP::Tumar::Provider::ImportPublicKey(
...
Aladdin::CAPI::CSP::Tumar::Provider::ExportPublicKey(
...
Aladdin::CAPI::CSP::KeyHandle^ 
Aladdin::CAPI::CSP::Tumar::Provider::ImportKeyPair(
...
Aladdin::CAPI::CSP::Tumar::Provider::GetPrivateKey(
...
{$
	...
	if (dynamic_cast<ANSI::RSA::IPublicKey^>(publicKey) != nullptr)
	{
		...
		// создать личный ключ
		return gcnew Microsoft::RSA::PrivateKey(
...
Aladdin::CAPI::CSP::Tumar::Provider::CreateGenerator(
...
Aladdin::CAPI::CSP::Tumar::Provider::CreateAlgorithm(
...
{$
	for (int i = 0; i < 1; i++)
	{
		...
		else if (type == CAPI::Encipherment::typeid)
		{
		...
		// для алгоритмов шифрования
		else if (type == CAPI::Decipherment::typeid)
		{
			// шифрование RSA не поддерживается
			if (oid == ASN1::ISO::PKCS::PKCS1::OID::rsa     ) return nullptr;
			if (oid == ASN1::ISO::PKCS::PKCS1::OID::rsa_oaep) return nullptr;
		...
		else if (type == CAPI::ITransportAgreement::typeid)
		{
