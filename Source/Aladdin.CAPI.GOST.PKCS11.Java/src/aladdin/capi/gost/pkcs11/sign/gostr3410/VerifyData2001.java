...
///////////////////////////////////////////////////////////////////////
public class VerifyData2001 extends aladdin.capi.gost.sign.gostr3410.VerifyData2001
{
    // используемый провайдер и апплет
    private final aladdin.capi.pkcs11.Provider provider; private final Applet applet; 
    
    // конструктор
    public VerifyData2001(aladdin.capi.pkcs11.Provider provider, 
        Applet applet, aladdin.capi.VerifyHash verifyAlgorithm) 
    { 
        // сохранить переданные параметры
        super(verifyAlgorithm); this.provider = RefObject.addRef(provider); 
