...
///////////////////////////////////////////////////////////////////////////
// Алгоритм наследования ключа PKCS12
///////////////////////////////////////////////////////////////////////////
public class PBKDFP12 extends aladdin.capi.KeyDerive
{
    // алгоритм шифрования по паролю, salt-значение и число итераций
    private final PBESP12 pbes; private final byte[] salt; private final int iterations;
    
	// конструктор
	protected PBKDFP12(PBESP12 pbes, byte[] salt, int iterations)
    { 
