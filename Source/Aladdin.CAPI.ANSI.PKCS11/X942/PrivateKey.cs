...
namespace Aladdin.CAPI.ANSI.PKCS11.X942
{
    ...
    public class PrivateKey : CAPI.PKCS11.PrivateKey, ANSI.X942.IPrivateKey
    {
	    ...
	    public static CAPI.PKCS11.Attribute[] GetAttributes(
            CAPI.PKCS11.Provider provider, ANSI.X942.IPrivateKey privateKey)
        {
            ...
            return new CAPI.PKCS11.Attribute[] { provider.CreateAttribute(API.CKA_KEY_TYPE, API.CKK_X9_42_DH),
	    ...
	    public PrivateKey(CAPI.PKCS11.Provider provider, SecurityObject scope, 
            CAPI.PKCS11.SessionObject obj, ANSI.X942.IPublicKey publicKey) 
            : base(provider, scope, publicKey.KeyOID)
        {
            ...
            parameters = (ANSI.X942.IParameters)publicKey.Parameters; 
