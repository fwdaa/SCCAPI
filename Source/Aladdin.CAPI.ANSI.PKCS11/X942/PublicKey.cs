...
namespace Aladdin.CAPI.ANSI.PKCS11.X942
{
    ...
    // Открытый ключ DH
    ///////////////////////////////////////////////////////////////////////////
    public class PublicKey : CAPI.PublicKey, ANSI.X942.IPublicKey
    {
	    ...
	    public static CAPI.PKCS11.Attribute[] GetAttributes(
            CAPI.PKCS11.Provider provider, ANSI.X942.IPublicKey publicKey)
        {
	    ...
	    public PublicKey(CAPI.PKCS11.Provider provider, CAPI.PKCS11.SessionObject obj)
            ...
            : base(provider.GetKeyFactory(ASN1.ANSI.OID.x942_dh_public_key))
        {
