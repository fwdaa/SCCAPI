...
namespace Aladdin.CAPI.ANSI.PKCS11.MAC
{
	...
	///////////////////////////////////////////////////////////////////////////////
	public class CBCMAC_AES : CAPI.PKCS11.Mac
	{
        // размер ключей и размер имитовставки
        private int[] keySizes; private int macSize; 

		// конструктор
		public CBCMAC_AES(CAPI.PKCS11.Applet applet, int[] keySizes) 
            
            // сохранить переданные параметры
            : this(applet, keySizes, 8) {} 

		// конструктор
		public CBCMAC_AES(CAPI.PKCS11.Applet applet, int[] keySizes, int macSize) : base(applet) 
        { 
