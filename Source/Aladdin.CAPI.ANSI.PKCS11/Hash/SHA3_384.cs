...
namespace Aladdin.CAPI.ANSI.PKCS11.Hash
{
	...
	///////////////////////////////////////////////////////////////////////////////
	public class SHA3_384 : CAPI.PKCS11.Hash
	{
		// конструктор
		public SHA3_384(CAPI.PKCS11.Applet applet) : base(applet) {}
		...
		public override int BlockSize { get { return 104; }}
		...
		public override int Finish(byte[] buf, int bufOff)
        {
            ...
            using (CAPI.Hash algorithm = new CAPI.ANSI.Hash.SHA3(384))
            {
