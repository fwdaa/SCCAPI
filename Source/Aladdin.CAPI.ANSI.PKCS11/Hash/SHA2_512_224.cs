...
namespace Aladdin.CAPI.ANSI.PKCS11.Hash
{
	...
	///////////////////////////////////////////////////////////////////////////////
	public class SHA2_512_224 : CAPI.PKCS11.Hash
	{
		// конструктор
		public SHA2_512_224(CAPI.PKCS11.Applet applet) : base(applet) {}
		...
		public override int Finish(byte[] buf, int bufOff)
        {
            ...
            using (CAPI.Hash algorithm = new CAPI.ANSI.Hash.SHA2_512_T(224))
            {
