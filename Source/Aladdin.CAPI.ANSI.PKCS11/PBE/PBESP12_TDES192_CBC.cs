...
namespace Aladdin.CAPI.ANSI.PKCS11.PBE
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public class PBESP12_TDES192_CBC : CAPI.PKCS11.PBE.PBESP12
    {
	    // конструктор 
	    public PBESP12_TDES192_CBC(CAPI.PKCS11.Applet applet, ulong algID, byte[] salt, int iterations)
        ...
        {
            // фабрика ключа
            get { return new Keys.TDES(new int[] {24}); }
        }
	    ...
	    protected override CAPI.Cipher CreateCipher(byte[] iv)
        {
            ...
            CAPI.Cipher cipher = Creator.CreateCipher(
                Applet.Provider, Applet, parameters, 24
            ); 
        ...
        { 
            ...
            return new CAPI.PKCS11.Attribute[] {
                Applet.Provider.CreateAttribute(API.CKA_KEY_TYPE, API.CKK_DES3)
            }; 
        } 
    }
}
