...
public final class BDHParamsList extends Sequence<IEncodable> 
{
	...
	private static final ObjectInfo[] info = new ObjectInfo[] { 
		...
		new ObjectInfo(new ObjectCreator(BDHParamsInitData  .class).factory(), Cast.O, Tag.ANY       ) 
	}; 
	// конструктор при раскодировании
	public BDHParamsList(IEncodable encodable) throws IOException { super(encodable, info); }  
	...
	public BDHParamsList(Integer bdhParameterL, Integer bdhParameterR, 
        ...
        BDSParamsInitData bdhParamInitData)
	{
		super(info, bdhParameterL, bdhParameterR, bdhParameterP, bdhParameterG, 
            bdhParameterN, bdhParamInitData); 
	}
	public final Integer            bdhParameterL   () { return (Integer            )get(0); } 
	public final Integer            bdhParameterR   () { return (Integer            )get(1); } 
	public final Integer            bdhParameterP   () { return (Integer            )get(2); } 
	public final Integer            bdhParameterG   () { return (Integer            )get(3); } 
	public final Integer            bdhParameterN   () { return (Integer            )get(4); } 
	public final BDHParamsInitData  bdhParamInitData() { return (BDHParamsInitData  )get(5); } 
    
	///////////////////////////////////////////////////////////////////////////
	// Параметры алгоритма СТБ 1176.2-99 (уровень 3)
	///////////////////////////////////////////////////////////////////////////
    private static final Integer L3 = new Integer(1022); 
    private static final Integer R3 = new Integer(161 ); 
	...
	private static final Integer G3 = new Integer(
        new BigInteger(1, new byte[] { 
    ...
    private static final Integer N3 = new Integer(256); 
	///////////////////////////////////////////////////////////////////////////
	// Параметры алгоритма СТБ 1176.2-99 (уровень 6)  
	///////////////////////////////////////////////////////////////////////////
    private static final Integer L6 = new Integer(1534); 
    private static final Integer R6 = new Integer(194 ); 
	...
	private static final Integer G6 = new Integer(
        new BigInteger(1, new byte[] { 
    ...
    private static final Integer N6 = new Integer(256); 
	///////////////////////////////////////////////////////////////////////////
	...
	private static final Integer G10 = new Integer(
        new BigInteger(1, new byte[] { 
    ...
    private static final Integer N10 = new Integer(256); 
	///////////////////////////////////////////////////////////////////////////
	// Таблица именованных параметров
	///////////////////////////////////////////////////////////////////////////
	private static final Map<String, BDHParamsList> set = 
        new HashMap<String, BDHParamsList>(); 
	static {
		set.put(OID.STB11762_PARAMS3_BDH , new BDHParamsList(L3,  R3,  P3,  G3,  N3,  null)); 
		set.put(OID.STB11762_PARAMS6_BDH , new BDHParamsList(L6,  R6,  P6,  G6,  N6,  null)); 
		set.put(OID.STB11762_PARAMS10_BDH, new BDHParamsList(L10, R10, P10, G10, N10, null)); 
	}
	// получить именованные параметры
	public static BDHParamsList parameters(String oid) { return set.get(oid); } 
}
