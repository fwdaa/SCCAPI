...
public class PrivateKey extends aladdin.capi.pkcs11.PrivateKey 
    implements aladdin.capi.ansi.x957.IPrivateKey
{
	...
	public static Attribute[] getAttributes(
        aladdin.capi.ansi.x957.IPrivateKey privateKey) throws IOException
    {
	...
	public PrivateKey(aladdin.capi.pkcs11.Provider provider, SecurityObject scope, 
        SessionObject object, aladdin.capi.ansi.x957.IPublicKey publicKey) throws IOException
    {
        ...
        parameters = (aladdin.capi.ansi.x957.IParameters)publicKey.parameters(); 
