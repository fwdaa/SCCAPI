...
// Открытый ключ DSA
///////////////////////////////////////////////////////////////////////////
public class PublicKey extends aladdin.capi.PublicKey implements aladdin.capi.ansi.x957.IPublicKey
{
	...
	public static Attribute[] getAttributes(aladdin.capi.ansi.x957.IPublicKey publicKey)
    {
        ...
        return new Attribute[] { new Attribute(API.CKA_KEY_TYPE, API.CKK_DSA),
	...
	public PublicKey(Provider provider, SessionObject object) throws IOException
    {
        ...
        super(provider.getKeyFactory(aladdin.asn1.ansi.OID.X957_DSA)); 
    ...
    // параметры ключа
    @Override public aladdin.capi.ansi.x957.IParameters parameters()
    {
        // параметры ключа
        return new aladdin.capi.ansi.x957.Parameters(p, q, g);     
    }
    // значение ключа
	@Override public final BigInteger getY() { return y; }
    
    // параметры ключа
    @Override public aladdin.capi.ansi.x957.IParameters getParams()
    {
        // параметры ключа
        return new aladdin.capi.ansi.x957.Parameters(p, q, g);     
    }
