...
///////////////////////////////////////////////////////////////////////////////
// Алгоритм шифрования RC2 в режиме CBC с дополнением PKCS5
///////////////////////////////////////////////////////////////////////////////
public class RC2_CBC_PAD extends aladdin.capi.pkcs11.BlockMode
{
	...
	// конструктор
	public RC2_CBC_PAD(Applet applet, int effectiveKeyBits, 
	...
	{ 
        ...
        if (keySizes != null) this.keySizes = keySizes; 
            ...
            MechanismInfo info = applet.getAlgorithmInfo(API.CKM_RC2_CBC_PAD); 
	...
	@Override public Mechanism getParameters(Session sesssion)
	{
        ...
        return new Mechanism(API.CKM_RC2_CBC_PAD, rc2Parameters); 
    }
    // тип ключа
