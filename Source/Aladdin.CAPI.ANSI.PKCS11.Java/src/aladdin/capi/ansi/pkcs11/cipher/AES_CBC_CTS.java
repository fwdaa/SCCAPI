...
///////////////////////////////////////////////////////////////////////////////
public class AES_CBC_CTS extends aladdin.capi.pkcs11.BlockMode
{
	// размер ключей и параметры алгоритма
	private final int[] keySizes; private final CipherMode.CBC parameters;  

	// конструктор
	public AES_CBC_CTS(Applet applet, int[] keySizes, CipherMode.CBC parameters) throws IOException
	{
		// сохранить переданные параметры
		super(applet, PaddingMode.CTS); this.parameters = parameters; 
