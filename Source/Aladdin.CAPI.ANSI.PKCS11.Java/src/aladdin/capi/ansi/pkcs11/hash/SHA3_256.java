...
///////////////////////////////////////////////////////////////////////////////
public class SHA3_256 extends aladdin.capi.pkcs11.Hash
{
	// конструктор
	public SHA3_256(Applet applet) { super(applet); }
	...
	@Override public int blockSize() { return 136; }
	...
	@Override public int finish(byte[] buf, int bufOff) throws IOException
    {
        ...
        try (aladdin.capi.Hash algorithm = new aladdin.capi.ansi.hash.SHA3(256))
        {
