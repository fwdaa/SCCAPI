...
///////////////////////////////////////////////////////////////////////////////
// Алгоритм хэширования SHA3-512
///////////////////////////////////////////////////////////////////////////////
public class SHA3_512 extends aladdin.capi.pkcs11.Hash
{
	// конструктор
	public SHA3_512(Applet applet) { super(applet); }
	
	// параметры алгоритма
	@Override protected Mechanism getParameters(Session session)
	{ 
		// выделить память для параметров
		return new Mechanism(API.CKM_SHA3_512); 
	}
	// размер хэш-значения в байтах
	@Override public int hashSize() { return 64; } 
	// размер блока в байтах
	@Override public int blockSize() { return 72; }
	...
	@Override public int finish(byte[] buf, int bufOff) throws IOException
    {
        ...
        try (aladdin.capi.Hash algorithm = new aladdin.capi.ansi.hash.SHA3(512))
        {
