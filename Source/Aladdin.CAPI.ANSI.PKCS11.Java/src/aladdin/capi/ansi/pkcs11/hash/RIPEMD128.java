...
///////////////////////////////////////////////////////////////////////////////
public class RIPEMD128 extends aladdin.capi.pkcs11.Hash
{
	// конструктор
	public RIPEMD128(Applet applet) { super(applet); }
	...
	@Override public int finish(byte[] buf, int bufOff) throws IOException
    {
        ...
        try (aladdin.capi.Hash algorithm = new aladdin.capi.ansi.hash.RIPEMD128())
        {
