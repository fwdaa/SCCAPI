...
///////////////////////////////////////////////////////////////////////////////
public class SHA2_384 extends aladdin.capi.pkcs11.Hash
{
	// конструктор
	public SHA2_384(Applet applet) { super(applet); }
	...
	@Override public int finish(byte[] buf, int bufOff) throws IOException
    {
        ...
        try (aladdin.capi.Hash algorithm = new aladdin.capi.ansi.hash.SHA2_384())
        {
