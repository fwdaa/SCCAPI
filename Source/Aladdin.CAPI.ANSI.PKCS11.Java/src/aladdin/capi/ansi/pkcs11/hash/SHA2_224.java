...
///////////////////////////////////////////////////////////////////////////////
// Алгоритм хэширования SHA2-224
///////////////////////////////////////////////////////////////////////////////
public class SHA2_224 extends aladdin.capi.pkcs11.Hash
{
	// конструктор
	public SHA2_224(Applet applet) { super(applet); }
	
	// параметры алгоритма
	@Override protected Mechanism getParameters(Session session)
	{ 
		// выделить память для параметров
		return new Mechanism(API.CKM_SHA224); 
	}
	...
	@Override public int finish(byte[] buf, int bufOff) throws IOException
    {
        ...
        try (aladdin.capi.Hash algorithm = new aladdin.capi.ansi.hash.SHA2_224())
        {
