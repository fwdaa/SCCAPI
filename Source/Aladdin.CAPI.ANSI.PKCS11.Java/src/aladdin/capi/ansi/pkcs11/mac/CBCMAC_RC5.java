...
///////////////////////////////////////////////////////////////////////////////
public class CBCMAC_RC5 extends aladdin.capi.pkcs11.Mac
{
	...
	// конструктор
    public CBCMAC_RC5(Applet applet, int blockSize, int rounds, int[] keySizes) throws IOException
	{ 
		// сохранить переданные параметры
        this(applet, blockSize, rounds, keySizes, blockSize / 2); 
    }
	// конструктор
    public CBCMAC_RC5(Applet applet, int blockSize, 
