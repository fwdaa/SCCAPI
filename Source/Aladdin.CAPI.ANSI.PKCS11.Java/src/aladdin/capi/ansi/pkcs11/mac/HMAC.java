...
///////////////////////////////////////////////////////////////////////////////
public class HMAC extends aladdin.capi.pkcs11.mac.HMAC
{
    ...
    // конструктор
    public HMAC(Applet applet, long hmacID, long hashID, int macSize) throws IOException
    {        
        // сохранить переданные параметры
        this(applet, hmacID, hashID, API.CKK_GENERIC_SECRET, macSize); 
    }
    // конструктор
    public HMAC(Applet applet, long hmacID, long hashID, long keyType, int macSize) throws IOException
    {        
        // сохранить переданные параметры
