...
namespace Aladdin.CAPI.PKCS11.PBE
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public class PBKDFP12 : CAPI.KeyDerive
    {
        // алгоритм шифрования по паролю, salt-значение и число итераций
        private PBESP12 pbes; private byte[] salt; private int iterations;
    
	    // конструктор
	    internal PBKDFP12(PBESP12 pbes, byte[] salt, int iterations)
        { 
