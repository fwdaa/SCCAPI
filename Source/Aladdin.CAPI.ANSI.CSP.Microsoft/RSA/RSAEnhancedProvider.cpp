...
#include "RSAEnhancedProvider.tmh"
#endif 
...
Aladdin::CAPI::ANSI::CSP::Microsoft::RSA::EnhancedProvider::GetSecretKeyType(
...
{$
	...
	return RSA::BaseProvider::GetSecretKeyType(keyFactory, keySize); 
}

Aladdin::CAPI::IAlgorithm^ 
Aladdin::CAPI::ANSI::CSP::Microsoft::RSA::EnhancedProvider::CreateAlgorithm(
