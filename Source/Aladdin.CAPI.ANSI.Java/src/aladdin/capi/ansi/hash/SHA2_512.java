...
///////////////////////////////////////////////////////////////////////////////
public class SHA2_512 extends BlockHash
{
	...
	// инициализировать алгоритм
	protected void init(long H1, long H2, long H3, long H4, long H5, long H6, long H7, long H8) throws IOException
    {
        ...
        byte[] data, int dataOff, int dataLen, byte[] buf, int bufOff)
    {
        ...
        Convert.fromInt64(H7, ENDIAN, buf,  bufOff + 48); 
        Convert.fromInt64(H8, ENDIAN, buf,  bufOff + 56); 
    }
    ////////////////////////////////////////////////////////////////////////////
