...
public final class DomainParameters extends Sequence<IEncodable>
{
	...
	private static final ObjectInfo[] info = new ObjectInfo[] { 
		...
		new ObjectInfo(new ObjectCreator(ValidationParms.class).factory(), Cast.O), 
	}; 
	// конструктор при раскодировании
	public DomainParameters(IEncodable encodable) throws IOException { super(encodable, info); }

	// конструктор при закодировании
	public DomainParameters(Integer p, Integer g, Integer q, Integer j, 
		ValidationParms validationParms)
    { 
        super(info, p, g, q, j, validationParms);  
    }
	public final Integer            p		  () { return (Integer          )get(0); }
	public final Integer            g		  () { return (Integer          )get(1); }
	public final Integer            q		  () { return (Integer          )get(2); }
	public final Integer            j		  () { return (Integer          )get(3); }
	public final ValidationParms	parameters() { return (ValidationParms  )get(4); }
	...
	public static final DomainParameters EPHEMERAL = new DomainParameters(
		new Integer(EPHEMERAL_P), new Integer(EPHEMERAL_G), new Integer(EPHEMERAL_Q), 
        null, new ValidationParms(EPHEMERAL_SEED, new Integer(371))
	); 
	// именованные параметры
	private static final BigInteger STATIC_P = new BigInteger(1, new byte[] {
	...
	private static final BigInteger STATIC_G = new BigInteger(1, new byte[] {
	...
	private static final BigInteger STATIC_Q = new BigInteger(1, new byte[] {
	...
	private static final BitString STATIC_SEED = new BitString(new byte[] {
		(byte)0xd5, (byte)0x01, (byte)0x4e, (byte)0x4b, 
        (byte)0x60, (byte)0xef, (byte)0x2b, (byte)0xa8, 
		(byte)0xb6, (byte)0x21, (byte)0x1b, (byte)0x40, 
        (byte)0x62, (byte)0xba, (byte)0x32, (byte)0x24, 
	...
	// экземпляр параметров
	public static final DomainParameters STATIC = new DomainParameters(
