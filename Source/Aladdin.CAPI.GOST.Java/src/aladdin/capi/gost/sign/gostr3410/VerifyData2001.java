...
public class VerifyData2001 extends VerifyData
{
    ...
    {
        // освободить выделенные ресурсы
        RefObject.release(hashAlgorithm); RefObject.release(verifyAlgorithm); super.onClose();
    }
    ...
    protected Hash createHashAlgorithm(String hashOID) throws IOException
    {
