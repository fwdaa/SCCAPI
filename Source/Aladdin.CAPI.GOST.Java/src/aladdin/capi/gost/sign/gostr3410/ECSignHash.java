...
public class ECSignHash extends SignHash
{
    ...
    protected static void knownTest(Factory factory, SecurityObject scope, 
        ...
        BigInteger qx, BigInteger qy, BigInteger d, 
        byte[] k, byte[] hash, byte[] signature) throws Exception
    {
        ...
        // создать личный ключ
        try (IPrivateKey privateKey = new ECPrivateKey(
    ...
    ////////////////////////////////////////////////////////////////////////////
    public static void test256(Factory factory, SecurityObject scope, 
        aladdin.capi.SignHash signHash, String keyOID, String hashOID) throws Exception
    {
        // выполнить тест
        knownTest(factory, scope, signHash, keyOID, 
            OID.ECC_SIGNS_TEST, hashOID, 
    ...
    public static void test512(Factory factory, SecurityObject scope, 
        aladdin.capi.SignHash signHash) throws Exception
    {
        // выполнить тест
        knownTest(factory, scope, signHash, OID.GOSTR3410_2012_512, 
