...
// Режим OFB
///////////////////////////////////////////////////////////////////////////////
public class OFB extends aladdin.capi.mode.OFB
{
    // режим смены ключа и размер смены ключа
    private final KeyDerive keyMeshing; private final int N; 
    
    // конструктор
	public OFB(Cipher engine, CipherMode.OFB parameters, KeyDerive keyMeshing, int N)
	{ 
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public static class Transform extends aladdin.capi.mode.OFB.Transform
    {
        ...
        public Transform(Cipher engine, KeyDerive keyMeshing, int N, 
            ISecretKey key, CipherMode.OFB parameters) 
        { 
            // сохранить переданные параметры
