...
public class CBC extends aladdin.capi.mode.CBC
{
    ...
    // конструктор
	public CBC(Cipher engine, CipherMode.CBC parameters, KeyDerive keyMeshing, int N, PaddingMode padding)
	{ 
        // сохранить переданные параметры
        super(engine, parameters, padding); this.N = N; 
        
        // сохранить переданные параметры
        this.keyMeshing = RefObject.addRef(keyMeshing); 
	}
    // конструктор
	public CBC(Cipher engine, CipherMode.CBC parameters, KeyDerive keyMeshing, int N)
	{ 
        // сохранить переданные параметры
	...
	{ 
        // сохранить переданные параметры
        super(engine, parameters, padding); this.keyMeshing = null; N = 0;  
	}
    // конструктор
    ...
    public static class Encryption extends aladdin.capi.mode.CBC.Encryption
    {
        ...
        public Encryption(Cipher engine, KeyDerive keyMeshing, int N, 
            ISecretKey key, CipherMode.CBC parameters) 
        { 
            // сохранить переданные параметры
