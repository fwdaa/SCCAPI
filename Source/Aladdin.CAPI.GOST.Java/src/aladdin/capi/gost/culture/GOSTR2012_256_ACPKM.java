...
///////////////////////////////////////////////////////////////////////////
public class GOSTR2012_256_ACPKM extends aladdin.capi.Culture
{
    // конструктор
    ...
    { 
        ...
        return new AlgorithmIdentifier(new ObjectIdentifier(oid),
            new GOSTR3410KEGParameters(new ObjectIdentifier(OID.GOSTR3410_2012_DH_256))
        ); 
    }
    ...
    public class PKCS12 extends PBEDefaultCulture
    {
        ...
        {         
            // сохранить переданные параметры
            super(new GOSTR2012_256_ACPKM(), parameters, true); 
        } 
    }
}
