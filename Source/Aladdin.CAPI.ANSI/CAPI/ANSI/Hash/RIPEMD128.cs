...
namespace Aladdin.CAPI.ANSI.Hash
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class RIPEMD128 : BlockHash
    {
        ...
        private long byteCount; private uint H0, H1, H2, H3;
	    ...
	    protected override void Update(byte[] data, int dataOff)  
        {
            ...
            uint a = H0; uint aa = H0;
            uint b = H1; uint bb = H1;
            uint c = H2; uint cc = H2;
            uint d = H3; uint dd = H3;
            //
            // Round 1
            //
            a = F1(a, b, c, d, X[ 0], 11);
