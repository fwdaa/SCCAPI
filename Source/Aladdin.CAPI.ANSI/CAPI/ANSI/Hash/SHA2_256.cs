...
namespace Aladdin.CAPI.ANSI.Hash
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class SHA2_256 : BlockHash
    {
        ...
        private long byteCount; private uint H1, H2, H3, H4, H5, H6, H7, H8;
	    ...
	    protected override void Update(byte[] data, int dataOff)  
        {
            ...
            uint[] X = new uint[64]; byteCount += BlockSize;
            ...
            uint e = H5; uint f = H6; uint g = H7; uint h = H8;
            ...
            byte[] data, int dataOff, int dataLen, byte[] buf, int bufOff)
        {
            ...
            Math.Convert.FromUInt32(H6, Endian, buf, bufOff + 20); 
            Math.Convert.FromUInt32(H7, Endian, buf, bufOff + 24); 
            Math.Convert.FromUInt32(H8, Endian, buf, bufOff + 28); 
        }
        ////////////////////////////////////////////////////////////////////////////
