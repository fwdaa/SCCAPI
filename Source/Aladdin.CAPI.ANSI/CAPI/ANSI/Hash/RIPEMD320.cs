...
namespace Aladdin.CAPI.ANSI.Hash
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class RIPEMD320 : BlockHash
    {
        ...
        private long byteCount; private uint H0, H1, H2, H3, H4, H5, H6, H7, H8, H9;

        // размер хэш-значения в байтах
	    public override int HashSize { get { return 40; }}
	    ...
	    protected override void Update(byte[] data, int dataOff)  
        {
            ...
            uint aa = H5; uint bb = H6; uint cc = H7; uint dd = H8; uint ee = H9; uint t; 
            //
            // Rounds 1 - 16
            //
            // left
            ...
            byte[] data, int dataOff, int dataLen, byte[] buf, int bufOff)
        {
            ...
            Math.Convert.FromUInt32(H8, Endian, buf, bufOff + 32); 
            Math.Convert.FromUInt32(H9, Endian, buf, bufOff + 36); 
        }
        ////////////////////////////////////////////////////////////////////////////
