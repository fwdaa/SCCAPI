namespace Aladdin.CAPI.ANSI.Culture
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    public class ECDSS_256 : CAPI.Culture
    {
        ...
        { 
            // вернуть параметры алгоритма
            return new ASN1.ISO.AlgorithmIdentifier(
                new ASN1.ObjectIdentifier(ASN1.ANSI.OID.rsa_hmac_sha2_256),
                ASN1.Null.Instance
            ); 
        }
        ...
        { 
            // вернуть параметры алгоритма
            return new ASN1.ISO.AlgorithmIdentifier(
                new ASN1.ObjectIdentifier(ASN1.ANSI.OID.nist_aes128_wrap),
                ASN1.Null.Instance
            ); 
        }
        ...
        { 
            // вернуть параметры алгоритма
            return new ASN1.ISO.AlgorithmIdentifier(
                new ASN1.ObjectIdentifier(ASN1.ANSI.OID.certicom_ecdh_std_sha2_256),
        ...
        {
            // конструктор
            public PKCS12(PBE.PBEParameters parameters) : base(new ECDSS_256(), parameters, true) {}
        }
    }
}
