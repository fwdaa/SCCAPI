...
{
    ///////////////////////////////////////////////////////////////////////////
    // Национальные особенности ГОСТ R34.10-2012 (512 бит)
    ///////////////////////////////////////////////////////////////////////////
    public class GOSTR2012_512 : GOST28147
    {
        // конструктор
        public GOSTR2012_512() : base(ASN1.GOST.OID.encrypts_tc26_z) {}
        ...
        { 
            // вернуть параметры алгоритма
            return new ASN1.ISO.AlgorithmIdentifier(
                new ASN1.ObjectIdentifier(ASN1.GOST.OID.gostR3410_2012_512),
                ASN1.Null.Instance
            ); 
        }
        ...
        public class PKCS12 : PBE.PBECulture
        {
            ...
            public PKCS12(PBE.PBEParameters parameters) 
                ...
                : base(parameters) { culture = new GOSTR2012_512(); } 
            ...
            { 
                // вернуть параметры алгоритма
                return new ASN1.ISO.AlgorithmIdentifier(
                    new ASN1.ObjectIdentifier(ASN1.GOST.OID.gostR3411_2012_HMAC_512), 
                    ASN1.Null.Instance
                ); 
            }
        }
