...
namespace Aladdin.CAPI.GOST.Mode.GOST28147
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class CFB_DEC : CAPI.Mode.CFB_DEC
    {
        ...
        // конструктор
        public CFB_DEC(CAPI.Cipher engine, KeyDerive keyMeshing, ISecretKey key, 
        ...
        // конструктор
        public CFB_DEC(CAPI.Cipher engine, ISecretKey key, 
            CipherMode.CFB parameters) : base(engine, key, parameters)
        { 
            // сохранить переданные параметры
