...
namespace Aladdin.CAPI.GOST.Mode.GOSTR3412
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class OFB_ENC : CAPI.Mode.OFB_ENC
    {
        ...
        // конструктор
        public OFB_ENC(CAPI.Cipher engine, KeyDerive keyMeshing, int N, 
            ISecretKey key, CipherMode.OFB parameters) : base(engine, key, parameters)
        { 
        ...
        // конструктор
        public OFB_ENC(CAPI.Cipher engine, ISecretKey key, 
            CipherMode.OFB parameters) : base(engine, key, parameters)
        { 
            // сохранить переданные параметры
