...
namespace Aladdin.CAPI.GOST.Mode.GOSTR3412
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    public class CBC_DEC : CAPI.Mode.CBC_DEC
    {
        ...
        // конструктор
        public CBC_DEC(CAPI.Cipher engine, KeyDerive keyMeshing, int N, 
            ISecretKey key, CipherMode.CBC parameters) : base(engine, key, parameters)
        { 
        ...
        // конструктор
        public CBC_DEC(CAPI.Cipher engine, ISecretKey key, 
