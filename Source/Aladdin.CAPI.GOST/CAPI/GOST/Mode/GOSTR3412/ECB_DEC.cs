...
namespace Aladdin.CAPI.GOST.Mode.GOSTR3412
{
   ...
   ///////////////////////////////////////////////////////////////////////////////
   public class ECB_DEC : CAPI.Mode.ECB_DEC
   {
       ...
       // конструктор
       public ECB_DEC(CAPI.Cipher engine, KeyDerive keyMeshing, int N, ISecretKey key) : base(engine, key)
       { 
       ...
       // конструктор
       public ECB_DEC(CAPI.Cipher engine, ISecretKey key) : base(engine, key)
       { 
           // сохранить переданные параметры
