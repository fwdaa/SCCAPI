// b5f048359ee01c0f053905c3c06451cd Generated file. Do not edit.
...
# define WPP_ANNOTATE_Trace_h1361_FINAL(P, File, Name, ...) __annotation( \
    L ## P, \
    L"16d1454d-74f6-3210-e056-5a960a4c574d Trace // SRC=" _WPPW(File) \
    L" MJ= MN=", \
    L"#typev " _WPPW(Name) \
    L" 10 \"%0--> %10!s!\" //   TRACELEVEL=TRACE_LEVEL_VERBOSE" \
    WPP_FUNC_NAME, \
...
#define WPP_LOCAL_TraceGuids WPP_16d1454d74f63210e0565a960a4c574d_Traceguids
extern const __declspec(selectany) GUID WPP_LOCAL_TraceGuids[] = { {0x16d1454d,0x74f6,0x3210,{0xe0,0x56,0x5a,0x96,0x0a,0x4c,0x57,0x4d}}, };
